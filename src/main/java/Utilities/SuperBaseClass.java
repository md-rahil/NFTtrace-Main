...
public static WebDriver driver;
	...
	public void launchingBrowser() throws Throwable
	{
		...
		String Browser = du.dataFromPropertiesFile("Sbrowser");
		...
		String URL = du.dataFromPropertiesFile("Surl");
		driver.get(URL);
	...
	public void loginToApplication() throws Throwable
	{
		...
		String Email = du.dataFromPropertiesFile("Semail");
		lg.getEmailTextField().sendKeys(Email);
		
		String Password = du.dataFromPropertiesFile("Spassword");
